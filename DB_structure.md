...
| public | subscription\_events |
| public | subscription\_invoices |
| public | subscription\_payments |
...
| audit\_logs | source | text | YES | NaN |
...
| businesses | current\_plan\_id | uuid | YES | NaN |
| businesses | payment\_provider | character varying | YES | NaN |
| businesses | provider\_customer\_id | character varying | YES | NaN |
| businesses | auto\_renew | boolean | NO | True |
| businesses | grace\_period\_end\_at | timestamp with time zone | YES | NaN |
| businesses | last\_renewed\_at | timestamp without time zone | YES | NaN |
| categories | category\_id | uuid | NO | gen\_random\_uuid() |
| categories | business\_id | uuid | NO | NaN |
...
| customers | business\_id | uuid | NO | NaN |
...
| expenses | business\_id | uuid | NO | NaN |
...
| low\_stock\_alerts | business\_id | uuid | NO | NaN |
...
| payments | business\_id | uuid | NO | NaN |
...
| payments | updated\_by | uuid | YES | NaN |
...
| plans | plan\_id | uuid | NO | gen\_random\_uuid() |
| plans | plan\_code | character varying | NO | NaN |
| plans | display\_name | character varying | NO | NaN |
| plans | billing\_cycle | character varying | NO | NaN |
| plans | price\_inr | numeric | YES | NaN |
| plans | price\_usd | numeric | YES | NaN |
| plans | razorpay\_plan\_id | character varying | YES | NaN |
| plans | stripe\_price\_id | character varying | YES | NaN |
| plans | feature\_limits | jsonb | NO | '{}'::jsonb |
| plans | is\_active | boolean | NO | True |
| plans | sort\_order | smallint | NO | 0 |
| plans | created\_at | timestamp with time zone | NO | now() |
| products | prod\_id | uuid | NO | gen\_random\_uuid() |
| products | business\_id | uuid | NO | NaN |
...
| purchase\_items | prod\_cost\_price\_before\_purchase | numeric | YES | NaN |
| purchase\_payments | payment\_id | uuid | NO | gen\_random\_uuid() |
| purchase\_payments | business\_id | uuid | NO | NaN |
| purchase\_payments | pur\_id | uuid | NO | NaN |
| purchase\_payments | payment\_amount | numeric | NO | NaN |
| purchase\_payments | payment\_method | character varying | YES | NaN |
| purchase\_payments | payment\_paid\_at | timestamp without time zone | YES | now() |
| purchase\_payments | payment\_status | character varying | NO | 'pending'::character varying |
| purchase\_payments | is\_active | boolean | NO | True |
| purchase\_payments | cumulative\_paid | numeric | YES | 0 |
| purchase\_payments | updated\_at | timestamp without time zone | YES | now() |
| purchase\_payments | updated\_by | uuid | YES | NaN |
...
| purchase\_return\_items | purchase\_item\_id | uuid | YES | NaN |
| purchase\_returns | return\_id | uuid | NO | gen\_random\_uuid() |
| purchase\_returns | business\_id | uuid | NO | NaN |
...
| purchase\_returns | updated\_by | uuid | YES | NaN |
| purchases | pur\_id | uuid | NO | gen\_random\_uuid() |
| purchases | business\_id | uuid | NO | NaN |
...
| purchases | pur\_invoice\_no | text | YES | NaN |
...
| sales | business\_id | uuid | NO | NaN |
...
| sales | updated\_by | uuid | YES | NaN |
...
| sales\_returns | business\_id | uuid | NO | NaN |
...
| sales\_returns | updated\_by | uuid | YES | NaN |
| stock\_movements | move\_id | uuid | NO | gen\_random\_uuid() |
| stock\_movements | business\_id | uuid | NO | NaN |
...
| subscription\_events | event\_id | uuid | NO | gen\_random\_uuid() |
| subscription\_events | provider | character varying | NO | NaN |
| subscription\_events | provider\_event\_id | character varying | NO | NaN |
| subscription\_events | event\_type | character varying | NO | NaN |
| subscription\_events | payload | jsonb | NO | NaN |
| subscription\_events | processed\_at | timestamp with time zone | YES | NaN |
| subscription\_events | created\_at | timestamp with time zone | NO | now() |
| subscription\_invoices | invoice\_id | uuid | NO | gen\_random\_uuid() |
| subscription\_invoices | business\_id | uuid | NO | NaN |
| subscription\_invoices | payment\_id | uuid | NO | NaN |
| subscription\_invoices | invoice\_number | character varying | NO | NaN |
| subscription\_invoices | amount | numeric | NO | NaN |
| subscription\_invoices | currency | character varying | NO | NaN |
| subscription\_invoices | provider\_invoice\_url | text | YES | NaN |
| subscription\_invoices | issued\_at | timestamp with time zone | NO | now() |
| subscription\_payments | payment\_id | uuid | NO | gen\_random\_uuid() |
| subscription\_payments | business\_id | uuid | NO | NaN |
| subscription\_payments | plan\_id | uuid | NO | NaN |
| subscription\_payments | provider | character varying | NO | NaN |
| subscription\_payments | provider\_order\_id | character varying | YES | NaN |
| subscription\_payments | provider\_payment\_id | character varying | YES | NaN |
| subscription\_payments | provider\_signature | text | YES | NaN |
| subscription\_payments | amount | numeric | NO | NaN |
| subscription\_payments | currency | character varying | NO | NaN |
| subscription\_payments | status | character varying | NO | 'created'::character varying |
| subscription\_payments | failure\_reason | text | YES | NaN |
...
| super\_admins | last\_logout\_at | timestamp without time zone | YES | NaN |
| suppliers | supp\_id | uuid | NO | gen\_random\_uuid() |
| suppliers | business\_id | uuid | NO | NaN |
...
| purchase\_payments | payment\_id |
...
| subscription\_events | event\_id |
| subscription\_invoices | invoice\_id |
| subscription\_payments | payment\_id |
| super\_admins | id |
| suppliers | supp\_id |
...
| businesses | current\_plan\_id | plans | plan\_id |
...
| payments | updated\_by | profiles | id |
...
| purchase\_payments | pur\_id | purchases | pur\_id |
| purchase\_payments | business\_id | businesses | business\_id |
| purchase\_return\_items | business\_id | businesses | business\_id |
| purchase\_return\_items | purchase\_item\_id | purchase\_items | item\_id |
...
| purchase\_returns | updated\_by | profiles | id |
...
| sales\_returns | updated\_by | profiles | id |
...
| subscription\_invoices | business\_id | businesses | business\_id |
| subscription\_invoices | payment\_id | subscription\_payments | payment\_id |
| subscription\_payments | business\_id | businesses | business\_id |
| subscription\_payments | plan\_id | plans | plan\_id |
...
| --- | --- | --- | --- |
| businesses | businesses\_current\_plan\_id\_fkey | f | FOREIGN KEY (current\_plan\_id) REFERENCES plans(plan\_id) |
| businesses | businesses\_pkey | p | PRIMARY KEY (business\_id) |
| profiles | fk\_profiles\_business\_id | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE RESTRICT |
...
| business\_counters | business\_counters\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE RESTRICT |
...
| categories | categories\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE RESTRICT |
...
| customers | customers\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE RESTRICT |
| customers | customers\_pkey | p | PRIMARY KEY (cust\_id) |
| suppliers | suppliers\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE RESTRICT |
...
| products | products\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE RESTRICT |
...
| sales | sales\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE RESTRICT |
| sales | fk\_sales\_updated\_by | f | FOREIGN KEY (updated\_by) REFERENCES profiles(id) ON DELETE SET NULL |
...
| sale\_items | sale\_items\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE RESTRICT |
...
| payments | payments\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE RESTRICT |
| payments | fk\_payments\_updated\_by | f | FOREIGN KEY (updated\_by) REFERENCES profiles(id) ON DELETE SET NULL |
...
| purchases | purchases\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE RESTRICT |
...
| purchase\_items | purchase\_items\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE RESTRICT |
...
| low\_stock\_alerts | low\_stock\_alerts\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE RESTRICT |
...
| stock\_movements | stock\_movements\_move\_type\_check | c | CHECK (((move\_type)::text = ANY (ARRAY['sale'::text, 'purchase'::text, 'adjustment'::text, 'sales\_return'::text, 'sales\_return\_reversal'::text, 'purchase\_return'::text, 'purchase\_return\_reversal'::text, 'damage'::text, 'purchase\_delete'::text, 'sale\_delete'::text]))) |
...
| stock\_movements | stock\_movements\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE RESTRICT |
| stock\_movements | ck\_stock\_movements\_move\_qty\_nonzero | c | CHECK ((move\_qty <> 0)) |
...
| sales\_returns | fk\_sales\_returns\_updated\_by | f | FOREIGN KEY (updated\_by) REFERENCES profiles(id) ON DELETE SET NULL |
| sales\_returns | sales\_returns\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE RESTRICT |
| expenses | chk\_expense\_amount\_positive | c | CHECK (((((expense\_category)::text = 'purchase\_refund'::text) AND (expense\_amount < (0)::numeric)) OR (((expense\_category)::text <> 'purchase\_refund'::text) AND (expense\_amount > (0)::numeric)))) |
| expenses | expenses\_expense\_category\_check | c | CHECK (((expense\_category)::text = ANY ((ARRAY['rent'::character varying, 'salary'::character varying, 'electricity'::character varying, 'internet'::character varying, 'maintenance'::character varying, 'marketing'::character varying, 'purchase'::character varying, 'purchase\_refund'::character varying, 'other'::character varying])::text[]))) |
| expenses | expenses\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE RESTRICT |
...
| purchase\_returns | fk\_purchase\_returns\_updated\_by | f | FOREIGN KEY (updated\_by) REFERENCES profiles(id) ON DELETE SET NULL |
| purchase\_returns | purchase\_returns\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE RESTRICT |
| purchase\_return\_items | purchase\_return\_items\_purchase\_item\_id\_fkey | f | FOREIGN KEY (purchase\_item\_id) REFERENCES purchase\_items(item\_id) |
...
| purchase\_return\_items | purchase\_return\_items\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE RESTRICT |
...
| plans | plans\_pkey | p | PRIMARY KEY (plan\_id) |
| plans | plans\_plan\_code\_key | u | UNIQUE (plan\_code) |
| subscription\_payments | subscription\_payments\_pkey | p | PRIMARY KEY (payment\_id) |
| subscription\_payments | subscription\_payments\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE CASCADE |
| subscription\_payments | subscription\_payments\_plan\_id\_fkey | f | FOREIGN KEY (plan\_id) REFERENCES plans(plan\_id) |
| subscription\_events | subscription\_events\_pkey | p | PRIMARY KEY (event\_id) |
| subscription\_invoices | subscription\_invoices\_payment\_id\_fkey | f | FOREIGN KEY (payment\_id) REFERENCES subscription\_payments(payment\_id) |
| subscription\_invoices | subscription\_invoices\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) ON DELETE CASCADE |
| subscription\_invoices | subscription\_invoices\_invoice\_number\_key | u | UNIQUE (invoice\_number) |
| subscription\_invoices | subscription\_invoices\_pkey | p | PRIMARY KEY (invoice\_id) |
| purchase\_payments | purchase\_payments\_pur\_id\_fkey | f | FOREIGN KEY (pur\_id) REFERENCES purchases(pur\_id) |
| purchase\_payments | purchase\_payments\_pkey | p | PRIMARY KEY (payment\_id) |
| purchase\_payments | purchase\_payments\_business\_id\_fkey | f | FOREIGN KEY (business\_id) REFERENCES businesses(business\_id) |
...
| public | audit\_logs | idx\_audit\_logs\_biz\_created | CREATE INDEX idx\_audit\_logs\_biz\_created ON public.audit\_logs USING btree (business\_id, created\_at DESC) |
...
| public | categories | ix\_categories\_business | CREATE INDEX ix\_categories\_business ON public.categories USING btree (business\_id, updated\_at) WHERE (is\_deleted = false) |
...
| public | customers | idx\_customers\_phone\_unique | CREATE UNIQUE INDEX idx\_customers\_phone\_unique ON public.customers USING btree (business\_id, cust\_phone) WHERE ((is\_deleted = false) AND (cust\_phone IS NOT NULL)) |
...
| public | low\_stock\_alerts | idx\_low\_stock\_alerts\_biz\_status | CREATE INDEX idx\_low\_stock\_alerts\_biz\_status ON public.low\_stock\_alerts USING btree (business\_id, alert\_status) |
...
| public | payments | idx\_payments\_sale\_id\_active | CREATE INDEX idx\_payments\_sale\_id\_active ON public.payments USING btree (sale\_id, is\_active) |
...
| public | payments | idx\_payments\_active\_sale\_id\_paid\_at | CREATE INDEX idx\_payments\_active\_sale\_id\_paid\_at ON public.payments USING btree (is\_active, sale\_id, payment\_paid\_at DESC) |
...
| public | plans | plans\_plan\_code\_key | CREATE UNIQUE INDEX plans\_plan\_code\_key ON public.plans USING btree (plan\_code) |
| public | plans | plans\_pkey | CREATE UNIQUE INDEX plans\_pkey ON public.plans USING btree (plan\_id) |
...
| public | purchase\_payments | purchase\_payments\_pkey | CREATE UNIQUE INDEX purchase\_payments\_pkey ON public.purchase\_payments USING btree (payment\_id) |
| public | purchase\_payments | idx\_purchase\_payments\_pur\_active | CREATE INDEX idx\_purchase\_payments\_pur\_active ON public.purchase\_payments USING btree (pur\_id, is\_active) |
| public | purchase\_payments | idx\_purchase\_payments\_pur\_id | CREATE INDEX idx\_purchase\_payments\_pur\_id ON public.purchase\_payments USING btree (pur\_id) |
| public | purchase\_payments | idx\_purchase\_payments\_biz\_active | CREATE INDEX idx\_purchase\_payments\_biz\_active ON public.purchase\_payments USING btree (business\_id, is\_active) |
...
| public | sales | uix\_sales\_invoice\_business | CREATE UNIQUE INDEX uix\_sales\_invoice\_business ON public.sales USING btree (business\_id, invoice\_no) WHERE (is\_deleted = false) |
...
| public | sales\_returns | idx\_sales\_returns\_sale | CREATE INDEX idx\_sales\_returns\_sale ON public.sales\_returns USING btree (business\_id, sale\_id) |
...
| public | stock\_movements | idx\_stock\_movements\_product | CREATE INDEX idx\_stock\_movements\_product ON public.stock\_movements USING btree (business\_id, product\_id, move\_created\_at DESC) |
| public | subscription\_events | subscription\_events\_pkey | CREATE UNIQUE INDEX subscription\_events\_pkey ON public.subscription\_events USING btree (event\_id) |
| public | subscription\_events | idx\_subscription\_events\_dedupe | CREATE UNIQUE INDEX idx\_subscription\_events\_dedupe ON public.subscription\_events USING btree (provider, provider\_event\_id) |
| public | subscription\_invoices | idx\_subscription\_invoices\_biz | CREATE INDEX idx\_subscription\_invoices\_biz ON public.subscription\_invoices USING btree (business\_id, issued\_at DESC) |
...
| payments | trg\_payments\_updated\_by\_insert | INSERT | BEFORE | EXECUTE FUNCTION fn\_set\_updated\_by() |
| payments | trg\_payments\_updated\_by | UPDATE | BEFORE | EXECUTE FUNCTION fn\_set\_updated\_by() |
...
| purchase\_returns | trg\_audit\_purchase\_returns | INSERT | AFTER | EXECUTE FUNCTION fn\_audit\_log() |
| purchase\_returns | trg\_purchase\_returns\_updated\_by | UPDATE | BEFORE | EXECUTE FUNCTION fn\_set\_updated\_by() |
| purchase\_returns | trg\_audit\_purchase\_returns | DELETE | AFTER | EXECUTE FUNCTION fn\_audit\_log() |
| purchase\_returns | trg\_audit\_purchase\_returns | UPDATE | AFTER | EXECUTE FUNCTION fn\_audit\_log() |
...
| sales | trg\_sales\_updated\_by | UPDATE | BEFORE | EXECUTE FUNCTION fn\_set\_updated\_by() |
...
| sales\_returns | trg\_sales\_returns\_updated\_by | UPDATE | BEFORE | EXECUTE FUNCTION fn\_set\_updated\_by() |
...
| get\_next\_purchase\_number | CREATE OR REPLACE FUNCTION public.get\_next\_purchase\_number(p\_business\_id uuid)\_x000D\_\n RETURNS text\_x000D\_\n LANGUAGE plpgsql\_x000D\_\nAS $function$\_x000D\_\nDECLARE\_x000D\_\n new\_counter INT;\_x000D\_\n purchase\_no TEXT;\_x000D\_\n prefix TEXT;\_x000D\_\nBEGIN\_x000D\_\n prefix := 'PUR';\_x000D\_\n\_x000D\_\n -- Lock row to prevent duplicate numbers under concurrent requests\_x000D\_\n UPDATE business\_counters\_x000D\_\n SET purchase\_counter = purchase\_counter + 1,\_x000D\_\n updated\_at = now()\_x000D\_\n WHERE business\_id = p\_business\_id\_x000D\_\n RETURNING purchase\_counter INTO new\_counter;\_x000D\_\n\_x000D\_\n -- If no counter row exists yet, create it\_x000D\_\n IF new\_counter IS NULL THEN\_x000D\_\n INSERT INTO business\_counters (business\_id, purchase\_counter, updated\_at)\_x000D\_\n VALUES (p\_business\_id, 1, now())\_x000D\_\n RETURNING purchase\_counter INTO new\_counter;\_x000D\_\n END IF;\_x000D\_\n\_x000D\_\n purchase\_no := prefix || '-' || LPAD(new\_counter::TEXT, 4, '0');\_x000D\_\n RETURN purchase\_no;\_x000D\_\nEND;\_x000D\_\n$function$\_x000D\_\n |
...
| public | purchase\_payments | True |
...
| public | subscription\_events | False |
| public | subscription\_invoices | True |
| public | subscription\_payments | True |
