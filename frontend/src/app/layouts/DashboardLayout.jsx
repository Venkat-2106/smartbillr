...
const NAV = [
  ...
  { label: 'Commerce', items: [
    ...
    { label: 'Payment Received',  path: '/payments',  permission: 'payments.manage',
  ...
  { label: 'System', items: [
    ...
    { label: 'User Guide', path: '/user-guide', permission: null,
...
export default function DashboardLayout() {
  ...
  const visibleNav = useMemo(() => {
    ...
    return NAV
      .map(section => ({ ...section, items: section.items.filter(item => !item.permission || permissions.includes(item.permission)) }))
