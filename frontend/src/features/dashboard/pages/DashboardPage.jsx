...
import { BentoCard, MetricCard, UpgradeBlur } from '../../../shared/components'
...
// ── Revenue vs Expenses ────────────────────────────────────────────
function RevenueExpensesBar({ revenue, expenses, country, loading, lockedReason }) {
  if (!loading && !lockedReason && (revenue == null || expenses == null)) return null
  ...
  return lockedReason ? <UpgradeBlur reason={lockedReason}>{content}</UpgradeBlur> : content
}
...
export default function DashboardPage() {
  ...
  const financialLockedReason = data?.financial_locked_reason
  ...
  ].filter(Boolean), [data, country, navigate, financialLockedReason])
    ...
    <div>
      ...
      <div className="bento-grid bento-grid-12">
        ...
        <RevenueExpensesBar
          ...
          country={country}
          loading={isLoading}
          lockedReason={financialLockedReason}
        />
