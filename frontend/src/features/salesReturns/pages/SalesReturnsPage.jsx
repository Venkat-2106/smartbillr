...
import SalesReturnDetailDrawer from '../components/SalesReturnDetailDrawer'
import { fetchSalesReturnsSummary } from '../api/salesReturnsApi'
...
export default function SalesReturnsPage() {
  ...
  const { data: returnsSummary } = useQuery({
    ...
    queryFn: fetchSalesReturnsSummary,
    staleTime: 5 * 60_000,
  })
  ...
  return (
    <>
      <PageHeader
        title="Sales Returns"
        subtitle="Manage product returns from customers and issue refunds"
        back
      ...
      {isError && (
        <div style={{
          ...
          Could not load sales returns. Check that the backend is running and refresh.
        </div>
      )}
