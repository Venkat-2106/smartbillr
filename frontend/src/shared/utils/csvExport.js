...
export const SALES_CSV_COLUMNS = [
  ...
  { key: 'sales_total_amount',     label: 'Total Amount' },
  { key: 'sales_discount',         label: 'Discount' },
  { key: 'cgst_total',             label: 'CGST' },
  { key: 'sgst_total',             label: 'SGST' },
  { key: 'igst_total',             label: 'IGST' },
  { key: 'tax_total',              label: 'Other Tax' },
  { key: 'sales_final_amount',     label: 'Final Amount' },
  { key: 'sales_payment_status',   label: 'Payment Status' },
  { key: 'sales_payment_method',   label: 'Payment Method' },
  { key: 'sales_created_at',       label: 'Date',
    format: (val) => val ? new Date(val).toLocaleDateString('en-IN') : '' },
];